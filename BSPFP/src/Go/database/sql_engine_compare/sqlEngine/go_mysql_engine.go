...
func main() {
	...
	stmtIn, err := sqlContext.Prepare("INSERT INTO " + tableName + " (emp_no, birth_date, first_name, last_name, gender, hire_date) VALUES (?, '1991-07-20', 'Hyung-Joo', 'Ahn', 'M', '1993-04-22')")
	if err != nil {
		log.Fatal(err)
	}
