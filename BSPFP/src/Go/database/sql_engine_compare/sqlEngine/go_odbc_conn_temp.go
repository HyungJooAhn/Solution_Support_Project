...
func main() {
	...
	// Insert Test //////////////////////////////////////
	stmtIn, err := sqlContext.Prepare("INSERT INTO " + tableName + " (emp_no, birth_date, first_name, last_name, gender, hire_date) VALUES (500000, TO_DATE('1991-07-20','YYYY-MM-DD'), 'Hyung-Joo', 'Ahn', 'M', TO_DATE('2016-03-22','YYYY-MM-DD'))")
	if err != nil {
		log.Fatal(err)
	}
	...
	*/
	...
	rows, err := sqlContext.SQLQuery("SELECT * FROM " + tableName)
